...
parser.add_argument('--du_dim', type=int, default=256, help='dimension of du embeddings')
...
parser.add_argument('--dim', type=int, default=256, help='dimension of entity and relation embeddings')
parser.add_argument('--du_dim', type=int, default=64, help='dimension of du embeddings')
